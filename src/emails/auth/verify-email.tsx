						...
						<Row>
							<Column align="center">
								...
								<Text className="max-w-lg text-lg text-neutral-500">
									Thank you for signing up! There&apos;s one more step before
									you continue, please verify your email so we know it&apos;s
									you.
								</Text>
							</Column>
						</Row>
						...
						<Row className="mt-8">
							<Column className="text-sm leading-3" align="center">
								<Text className="text-neutral-500">
									...
									didn&apos;t sign up for BoostCart, please ignore this email.
								</Text>
								<Text className="text-neutral-500">
...
VerifyEmail.PreviewProps = {
	...
	requestNewLink:
		"http://localhost:3000/verify-email?resend=true&email=johndoe@example.com",
};
