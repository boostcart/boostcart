...
import { Body, Column, Font, Head, Heading, Html, Link, Row, Section, Tailwind, Text } from "@react-email/components";
			...
			<Tailwind>
				<Body className='p-4 bg-neutral-100'>
					...
					<Section className='w-full p-4 bg-white rounded-md shadow-xs'>
						<Row>
							<Column align='center'>
								<Heading as='h2'>Hey, {name}! Did you change your password?</Heading>
								<Text className='max-w-lg text-lg text-neutral-500'>We noticed the password for your BoostCart account was recently changed. If this was you, you can safely ignore this email.</Text>
							</Column>
						</Row>
						<Row className='max-w-lg'>
							<Column className='w-full p-4 rounded-md shadow-xs bg-neutral-100' align='center'>
								<Row>
									<Column>
						...
						<Row className='mt-8'>
							<Column className='text-sm leading-3' align='center'>
								<Text className='text-neutral-500'>This email was sent to <strong>{email}</strong>. If that&apos;s not you, please ignore this email.</Text>
							</Column>
						</Row>
					</Section>
					<MailFooter />
