module.exports = [
	...
	"[project]/apps/platform/src/server/api/internal/data:bf1b4b [app-ssr] (ecmascript) <text/javascript>",
	(__turbopack_context__) => {
		"use strict";
	...
	"[project]/apps/platform/src/server/api/internal/data:d31dad [app-ssr] (ecmascript) <text/javascript>",
	(__turbopack_context__) => {
		"use strict";
	...
	"[project]/apps/platform/src/server/api/internal/data:7a5e03 [app-ssr] (ecmascript) <text/javascript>",
	(__turbopack_context__) => {
		"use strict";
	...
	(__turbopack_context__) => {
		...
		(() => {
			const e = new Error(
				"Cannot find module '@/components/admin/polaris-button'",
			);
		...
		var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$bf1b4b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ =
			__turbopack_context__.i(
				"[project]/apps/platform/src/server/api/internal/data:bf1b4b [app-ssr] (ecmascript) <text/javascript>",
			);
		var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$d31dad__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ =
			__turbopack_context__.i(
				"[project]/apps/platform/src/server/api/internal/data:d31dad [app-ssr] (ecmascript) <text/javascript>",
			);
		var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$7a5e03__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ =
			__turbopack_context__.i(
				"[project]/apps/platform/src/server/api/internal/data:7a5e03 [app-ssr] (ecmascript) <text/javascript>",
			);
		("use client");
		function PagesPage() {
			...
			__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
				...
				try {
					...
					__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$d31dad__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__[
						"getPages"
					])();
					setPages(pagesData);
				} catch {
			...
			const handleToggleActive = async (page) => {
				try {
					await (0,
					__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$7a5e03__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__[
						"togglePageActive"
					])(page.id);
					__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
						"toast"
			...
			const handleDelete = async () => {
				...
				try {
					setDeleting(true);
					await (0,
					__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$bf1b4b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__[
						"deletePage"
					])(selectedPage.id);
					__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
						"toast"
...
//# sourceMappingURL=apps_platform_src_7b8b39af._.js.map
