module.exports = [
	...
	"[project]/apps/platform/src/server/api/internal/data:00a605 [app-ssr] (ecmascript) <text/javascript>",
	(__turbopack_context__) => {
		"use strict";
	...
	(__turbopack_context__) => {
		...
		var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$8b73a3__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ =
			__turbopack_context__.i(
				"[project]/apps/platform/src/server/api/internal/data:8b73a3 [app-ssr] (ecmascript) <text/javascript>",
			);
		var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$4498d5__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ =
			__turbopack_context__.i(
				"[project]/apps/platform/src/server/api/internal/data:4498d5 [app-ssr] (ecmascript) <text/javascript>",
			);
		var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$1720a9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ =
			__turbopack_context__.i(
				"[project]/apps/platform/src/server/api/internal/data:1720a9 [app-ssr] (ecmascript) <text/javascript>",
			);
		var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$779bd1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ =
			__turbopack_context__.i(
				"[project]/apps/platform/src/server/api/internal/data:779bd1 [app-ssr] (ecmascript) <text/javascript>",
			);
		var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$00a605__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ =
			__turbopack_context__.i(
				"[project]/apps/platform/src/server/api/internal/data:00a605 [app-ssr] (ecmascript) <text/javascript>",
			);
		...
		function BlogPage() {
			...
			async function loadData() {
				try {
					...
					const [postsData, statsData, localeData] = await Promise.all([
						(0,
						__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$4498d5__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__[
							"getBlogPosts"
						])(),
						(0,
						__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$1720a9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__[
							"getBlogStats"
						])(),
						(0,
			...
			const handleTogglePublished = async (post) => {
				try {
					await (0,
					__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$779bd1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__[
						"toggleBlogPostPublished"
					])(post.id);
					__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
						"toast"
			...
			const handleSubmit = async () => {
				...
				try {
					...
					if (formMode === "create") {
						...
						await (0,
						__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$00a605__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__[
							"updateBlogPost"
						])(selectedPost.id, {
							slug: formData.slug,
							author: formData.author || undefined,
			...
			const handleDelete = async () => {
				...
				try {
					setDeleting(true);
					await (0,
					__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$platform$2f$src$2f$server$2f$api$2f$internal$2f$data$3a$8b73a3__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__[
						"deleteBlogPost"
					])(selectedPost.id);
					__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
						"toast"
															...
															],
															{
																children: [
																	...
																	__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
																		...
																		{
																			children:
																				"Start writing blog posts to engage with your customers and improve SEO",
																		},
																		void 0,
																		false,
																		{
																				...
																				__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
																					...
																					"p",
																					{
																						className:
																							"text-sm text-muted-foreground",
																						children:
																							"Make this post visible on your store",
																					},
																					void 0,
																					false,
																					{
...
//# sourceMappingURL=apps_platform_src_2c454c74._.js.map
