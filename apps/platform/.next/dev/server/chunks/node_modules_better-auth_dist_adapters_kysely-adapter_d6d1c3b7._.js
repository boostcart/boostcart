module.exports = [
	"[project]/node_modules/better-auth/dist/adapters/kysely-adapter/kysely-adapter.mjs [app-route] (ecmascript)",
	(__turbopack_context__) => {
		"use strict";

		__turbopack_context__.s(["kyselyAdapter", () => kyselyAdapter]);
						...
						for (const currentRow of rows) {
							...
							if (!groupedByMainId.has(mainId)) {
								...
								for (const [joinModel, joinAttr] of Object.entries(joinConfig))
									entry$1[getModelName(joinModel)] =
								...
								if (joinAttr.relation !== "one-to-one") {
									...
									if (Array.isArray(entry[joinModelName])) {
										...
										if (entry[joinModelName].length > limit)
											entry[joinModelName] = entry[joinModelName].slice(
												0,
												limit,
											);
									}
					...
					return {
						async create({ data, model }) {
							return await withReturning(
								data,
								db$1.insertInto(model).values(data),
								model,
								[],
							);
						},
						async findOne({ model, where, select, join }) {
							...
							let query = db$1
								.selectFrom((eb) => {
									...
									if (and)
										b = b.where((eb$1) =>
											eb$1.and(and.map((expr) => expr(eb$1))),
										);
									if (or)
										b = b.where((eb$1) =>
											eb$1.or(or.map((expr) => expr(eb$1))),
										);
							...
							const row = res[0];
							if (join)
								return processJoinedResults(res, join, allSelectsStr)[0];
							return row;
						},
						...
						async count({ model, where }) {
							...
							let query = db$1
								.selectFrom(model)
								.select(db$1.fn.count("id").as("count"));
							if (and)
								query = query.where((eb) =>
									eb.and(and.map((expr) => expr(eb))),
								);
	...
	"[project]/node_modules/better-auth/dist/adapters/kysely-adapter/index.mjs [app-route] (ecmascript) <locals>",
	(__turbopack_context__) => {
		"use strict";
		...
		var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$kysely$2d$adapter$2f$kysely$2d$adapter$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
			__turbopack_context__.i(
				"[project]/node_modules/better-auth/dist/adapters/kysely-adapter/kysely-adapter.mjs [app-route] (ecmascript)",
			);
	},
	...
	(__turbopack_context__) => {
		...
		__turbopack_context__.s([
			...
			"kyselyAdapter",
			() =>
				__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$kysely$2d$adapter$2f$kysely$2d$adapter$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
					"kyselyAdapter"
				],
		]);
		var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$kysely$2d$adapter$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ =
			__turbopack_context__.i(
				"[project]/node_modules/better-auth/dist/adapters/kysely-adapter/index.mjs [app-route] (ecmascript) <locals>",
			);
		var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$kysely$2d$adapter$2f$dialect$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
